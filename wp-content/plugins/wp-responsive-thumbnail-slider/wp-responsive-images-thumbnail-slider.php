...
function rts_responsive_thumbnail_slider_remove_access_capabilities(){
    ...
    function responsive_thumbnail_slider_load_styles_and_js(){
         ...
         if (!is_admin()) {                                                       
            ...
            wp_register_script('images-responsive-thumbnail-slider-jc',plugins_url('/js/images-responsive-thumbnail-slider-jc.js', __FILE__),array(),'1.1.1');
...
<?php       
 ...
 ?><!-- print_responsive_thumbnail_slider_func --><style type='text/css' >
        ...
        <div style="clear: both;"></div>
        <?php $url = plugin_dir_url(__FILE__);  ?>
         <div style="width: auto;postion:relative;visibility: hidden" id="divSliderMain">
           <div class="responsiveSlider" style="margin-top: 2px !important;">
              <?php
                      global $wpdb;
                      $imageheight=$settings['imageheight'];
                     ...
                     <?php endif;?>
                       ...
                       <?php endif;?>
                        onSliderLoad: function(){
                            ...
                            $n("#divSliderMain").css('visibility','visible');
                        }
