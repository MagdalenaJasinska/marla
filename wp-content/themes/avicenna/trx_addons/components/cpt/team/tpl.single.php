...
while ( have_posts() ) { the_post();
	?>
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'team_member_page itemscope ' . (( !trx_addons_sc_layouts_showed('featured') && has_post_thumbnail() ) ? ' with_feautered_image' : '') ); trx_addons_seo_snippets('', 'Article'); ?>>
		...
		?><div class="team_member_description"><?php
			...
			if (!empty($meta['brief_info'])) {
				...
				<div class="team_member_brief_info">
					<h5 class="team_member_brief_info_title"><?php esc_attr_e('Brief info', 'avicenna'); ?></h5>
