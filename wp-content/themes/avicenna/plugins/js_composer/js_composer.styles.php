...
if ( !function_exists( 'avicenna_vc_get_css' ) ) {
	add_filter( 'avicenna_filter_get_css', 'avicenna_vc_get_css', 10, 4 );
	function avicenna_vc_get_css($css, $colors, $fonts, $scheme='') {
...
.vc_progress_bar.vc_progress_bar_narrow .vc_single_bar:nth-child(2n) .vc_label .vc_label_units {
	color: {$colors['text_link']};
}
...
.vc_progress_bar.vc_progress_bar_narrow[class*='vc_custom'] .vc_single_bar:nth-child(2n) .vc_label .vc_label_units,
