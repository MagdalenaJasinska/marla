...
if (!function_exists('avicenna_trx_addons_get_css')) {
	add_filter('avicenna_filter_get_css', 'avicenna_trx_addons_get_css', 10, 4);
	function avicenna_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.sc_matches_item_pair .sc_matches_item_player .post_featured > img {
	-webkit-border-radius: 2.222em {$rad};
	    -ms-border-radius: 2.222em {$rad};
			border-radius: 2.222em {$rad};
}
...
.sidebar_inner .socials_wrap .social_item .social_icon,
.sidebar_inner .socials_wrap .social_item .social_icon i {
	color: {$colors['text']};
}
...
.scheme_self .sc_form .sc_item_descr {
    color: {$colors['text_dark']};
}
.scheme_dark .sc_title_default .sc_item_descr {
    color: {$colors['bg_color']};
}
.scheme_dark .sc_item_subtitle {
    color: {$colors['bg_color']};
}
.scheme_dark .sc_form input[type="text"],
.scheme_dark .sc_form textarea {
	color: {$colors['input_text']};
	border-color: {$colors['bg_color']};
	background-color: {$colors['bg_color']};
}
.scheme_dark .sc_form input[placeholder]::-webkit-input-placeholder,
.scheme_dark .sc_form textarea[placeholder]::-webkit-input-placeholder	{ color: {$colors['input_light']}; }
.scheme_dark .sc_form input[placeholder]::-moz-placeholder,
.scheme_dark .sc_form textarea[placeholder]::-moz-placeholder				{ color: {$colors['input_light']}; }
.scheme_dark .sc_form input[placeholder]:-ms-input-placeholder,
.scheme_dark .sc_form textarea[placeholder]:-ms-input-placeholder			{ color: {$colors['input_light']}; }
.scheme_dark .sc_form input[placeholder]::placeholder,
.scheme_dark .sc_form textarea[placeholder]::placeholder					{ color: {$colors['input_light']}; }
...
.vc_row-has-fill .sc_form input[type="text"] {
	border-color: {$colors['alter_bg_hover']};
	background-color: {$colors['alter_bg_hover']};
}

.vc_row-has-fill .sc_form button {
	background-color: {$colors['text_hover']};
}
.vc_row-has-fill .sc_form button:hover {
	background-color: {$colors['text_link']};
}
.widget_contacts .contacts_info span:before,
.widget_contacts .contacts_info > div > a:before,
